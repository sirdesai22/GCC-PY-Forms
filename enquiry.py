...
def run():
    ...
    # def open_redirect_window():
    #     redirect_window = tk.Toplevel(window)
    #     redirect_window.geometry('400x200')
    #     redirect_window.title("Redirect Window")
    #     redirect_window.configure(bg="lavender")

    #     label_redirect = tk.Label(redirect_window, text="This is a redirect window.", font='ALGERIAN 20', bg="lavender")
    #     label_redirect.pack()
    ...
    # redirect_button = tk.Button(window, text="Redirect", command=open_redirect_window, font='arial 15')
    # redirect_button.place(x=540, y=350)
